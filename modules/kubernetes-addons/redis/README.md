...
This add-on configures [Redis Helm Chart](https://github.com/bitnami/charts/tree/main/bitnami/redis)
...
| <a name="input_helm_config"></a> [helm\_config](#input\_helm\_config) | Helm provider config for Redis. | `any` | `{}` | no |
