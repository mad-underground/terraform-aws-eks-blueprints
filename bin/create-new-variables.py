...
files_to_process = [
    {
        ...
        'destination_var_file': 'examples/_using-object/variables.tf',
        'destination_main_file': 'examples/_using-object/main.tf',
        'variable_name': 'eks_cluster',
        'description': 'AWS EKS cluster resources to be created',
        'module_name': 'eks',
        'module_source': 'github.com/mad-underground/terraform-aws-eks-blueprints?ref=develop-v4.21.0'
    }
]
