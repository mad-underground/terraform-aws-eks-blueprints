...
files_to_process = [
    {
        ...
        'destination_var_file': 'eks_cluster-variables.tf',
        'destination_main_file': 'eks_cluster-main.tf',
    ...
    {
        'source_var_file': '../kubernetes-addons/variables.tf',
        'destination_var_file': 'kubernetes_addons-variables.tf',
        'destination_main_file': 'kubernetes_addons-main.tf',
        'variable_name': 'kubernetes_addons',
        'description': 'AWS EKS kubernetes addons to be created',
        'module_name': 'kubernetes_addons',
        'module_source': '../kubernetes-addons/'
    }
]
...
def main():
    ...
    for file in files_to_process:
        ...
        dest_var_file = file['destination_var_file']
        dest_main_file = file['destination_main_file']
        ...
        with open(dest_main_file, 'w') as write_main_f:
            ...
            write_main_f.write(f'  count = var.{file["variable_name"]} == null ? 0 : 1\n')
